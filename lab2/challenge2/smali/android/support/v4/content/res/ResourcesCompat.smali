...
.method private static loadFont(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroid/widget/TextView;)Landroid/graphics/Typeface;
    ...
    .line 236
    .local v13, "cached":Landroid/graphics/Typeface;
    if-eqz v13, :cond_52
    ...
    .line 244
    invoke-static {v14, v7}, Landroid/support/v4/content/res/FontResourcesParserCompat;->parse(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
    ...
    move-result-object v1
    :try_end_7f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_52 .. :try_end_7f} :catch_a6
    .catch Ljava/io/IOException; {:try_start_52 .. :try_end_7f} :catch_8b
    ...
    :try_start_82
    invoke-static {v1, v7, v9, v11, v10}, Landroid/support/v4/graphics/TypefaceCompat;->createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;

    move-result-object v2
    :try_end_86
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_82 .. :try_end_86} :catch_89
